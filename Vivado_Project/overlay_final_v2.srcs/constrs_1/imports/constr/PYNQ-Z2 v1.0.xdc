...
#create_clock -add -name sys_clk_pin -period 20.0 -waveform {0 4} [get_ports { sysclk }];
...
#set_property -dict { PACKAGE_PIN L15   IOSTANDARD LVCMOS33 } [get_ports { oLed }]; #IO_L22N_T3_AD7N_35 Sch=led4_b
