...
HD_PWD='D:/YANLIU/KULeuven/course/master/thesis/Project/overlay_final_v2/overlay_final_v2/overlay_final_v2.runs/design_2_AXI_Allpass_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_AXI_Allpass_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_AXI_Allpass_0_0.tcl
